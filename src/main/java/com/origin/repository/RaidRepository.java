...
public interface RaidRepository extends JpaRepository<Raid, Long> {
    ...
    List<Raid> findByTemplateIdAndDateGreaterThanEqualAndDateLessThanOrderByDateAsc(Long templateId,
                                                                                     LocalDateTime start,
                                                                                     LocalDateTime end);
    ...
    @Query("SELECT DISTINCT r FROM Raid r " +
            ...
            "LEFT JOIN FETCH g2.joueur " +
            "WHERE r.id IN :ids")
    List<Raid> findAllWithGroupsByIdIn(@Param("ids") List<Long> ids);
